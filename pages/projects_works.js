    ...
    return (
      <div className="rounded overflow-hidden shadow-lg bg-gray-100">
        ...
        <div className="flex justify-center px-6 py-4 mt-1 md:mt-2 lg:mt-4">
          <button className="flex items-center rounded-lg bg-green-600 px-2 text-sm md:text-lg lg:text-xl xl:text-2xl 2k:text-2xl font-semibold text-white project_card_button focus:outline-none">
